                    ...
                    <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                        <nav class="menu menu--iris">
                            <ul class="nav navbar-nav menu__list">
                                ...
                                <li class="menu__item"><a href="#" class="menu__link">Album</a></li>
                                <li class="menu__item"><a href="#" class="menu__link">Theme</a></li>
                                <li class="menu__item"><a href="#" class="menu__link">Blog</a></li>
                                <li class="menu__item"><a href="#" class="menu__link">Mail Us</a></li>
                            </ul>
                        </nav>
                    </div>
                </nav>
                    ...
                    <section>
                        <div class="modal-body">
                            <div class="col-md-6 w3_modal_body_left">
                                <img src="<?php echo $this->webroot.'/web/images/15.jpg'; ?>" alt=" " class="img-responsive" />
                            </div>
