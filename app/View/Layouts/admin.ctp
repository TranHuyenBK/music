...
<html>
    <head>
        ...
        <?php 
            ...
            echo $this->Html->css('/admin/css/font-awesome.min.css');
            echo $this->Html->css('/admin/css/ionicons.min.css');
            echo $this->Html->css('/admin/css/morris/morris.css');
            echo $this->Html->css('/admin/css/jvectormap/jquery-jvectormap-1.2.2.css');
            echo $this->Html->css('/admin/css/fullcalendar/fullcalendar.css');
            echo $this->Html->css('/admin/css/daterangepicker/daterangepicker-bs3.css');
            echo $this->Html->css('/admin/css/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css');
    ...
    <body class="skin-blue">
        ...
        <!-- jQuery 2.0.2 -->
        <?php 
            // echo $this->Html->script('/admin/js/jquery-ui-1.10.3.min.js'); 
            // echo $this->Html->script('/admin/js/bootstrap.min.js'); 
            // echo $this->Html->script('/admin/js/plugins/morris/morris.min.js'); 
            echo $this->Html->script('/admin/js/plugins/sparkline/jquery.sparkline.min.js'); 
            // echo $this->Html->script('/admin/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'); 
            // echo $this->Html->script('/admin/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'); 
            echo $this->Html->script('/admin/js/plugins/fullcalendar/fullcalendar.min.js'); 
            echo $this->Html->script('/admin/js/plugins/jqueryKnob/jquery.knob.js'); 
            echo $this->Html->script('/admin/js/plugins/daterangepicker/daterangepicker.js');
            echo $this->Html->script('/admin/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js');
            echo $this->Html->script('/admin/js/plugins/iCheck/icheck.min.js');
            echo $this->Html->script('/admin/js/AdminLTE/app.js');
            echo $this->Html->script('/admin/js/AdminLTE/dashboard.js');
            echo $this->Html->script('/admin/js/AdminLTE/demo.js');
            echo $this->Html->script('/admin/js/bootstrap.min.js');
